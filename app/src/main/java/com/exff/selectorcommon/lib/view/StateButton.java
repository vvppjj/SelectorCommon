package com.exff.selectorcommon.lib.view;
...
import com.exff.selectorcommon.R;
...
public class StateButton extends AppCompatButton {
    ...
    private  void setup(AttributeSet attrs){
        ...
        mPressedTextColor=a.getColor(R.styleable.StateButton_normalTextColor,mDefaultPressedTextColor);
        mUnableTextColor=a.getColor(R.styleable.StateButton_normalTextColor,mDefaultUnableTextColor);
        setTextColor();
    ...
    public void setmNormalStrokeColor(@ColorInt int normalStrokeColor){
        this.mNormalStrokeColor=normalStrokeColor;
        setStroke(mNormalBackground,mNormalStrokeColor,mNormalStrokeWidth);
    }

    public void setmPressedStrokeColor(@ColorInt int pressedStrokeColor){
